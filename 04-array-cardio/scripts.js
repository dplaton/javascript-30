(function() {
    ...
    const filtered = inventors.filter(
        element => element.year >= 1500 && element.year <= 1599
    );
    ...
    console.log("Inventor's first and last name:");
    ...
    console.log("Inventors sorted by birthdate, oldest first");
    ...
    console.log(`How many years did all the inventors live? ${yearsLived}`);
    ...
    console.log("Invetors sorted by age");
    ...
    const sortedPeople = people.sort((firstOne, nextOne) => {
    ...
    const reduced = data.reduce((acc, element) => {
